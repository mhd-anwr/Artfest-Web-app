      ...
      <div className="p-4 md:p-8 lg:p-12 max-w-7xl mx-auto relative z-20">
        ...
        >
          ...
          <div className="text-center mb-8 sm:mb-10 px-4">
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-semibold text-[#115F32] dark:text-[#D4FFB8] tracking-wide">
          ...
          <div className="max-w-4xl lg:max-w-5xl mx-auto px-5 sm:px-8">
            <p className="text-base sm:text-lg md:text-xl font-normal text-[#115F32] dark:text-[#D4FFB8] leading-relaxed sm:leading-loose text-left md:text-justify">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-[#115F32] dark:text-[#8ED06C] text-sm sm:text-base leading-loose mb-12 px-2">
